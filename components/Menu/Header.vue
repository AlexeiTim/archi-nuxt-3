...
<template>
  <div class="flex items-center justify-between py-2 md:p-10">
      ...
      <div class="flex gap-5 items-center">
        <div
          ...
          :class="
            ...
            `bg-text_bg font-['FuturaDemiC'] font-semibold cursor-pointer px-[3px] py-[6px] bg-opacity-10 rounded-[5px]`
          "
        >
          {{ language.label }}
        </div>
    ...
    <div
      class="flex group items-center gap-[14px] cursor-pointer hover:scale-105 transition"
      @click="emits('show-menu', false)"
    >
      <span
        class="text-['FuturaDemiC'] group-hover:text-dark_green font-semibold text-[16px]/[18.92px] text-black hidden md:inline"
        >Close</span
      >
