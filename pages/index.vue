...
<template>
  <div
    class="size-full bg-[#F3F3F3] lg:bg-[length:100%_100%] sm:bg-[length:100%_50%] bg-[length:0%_0%] md:bg-[length:100%_70%] bg-no-repeat bg-right-bottom lg:bg-center transition-all"
    :style="{
